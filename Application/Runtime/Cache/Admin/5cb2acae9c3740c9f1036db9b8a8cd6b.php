					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" action="/shop/admin.php/Index/update" method="post" role="form" enctype="multipart/form-data">
								    
									<input type="hidden" name="index_id" value="<?php echo ($index['index_id']); ?>"/>
...
、
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 栏  目：</label>

										<div class="col-sm-9">
											<input type="text" id="form-field-2" name="index_name" value="<?php echo ($index[index_name]); ?>" class="col-xs-10 col-sm-5" readonly/>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 图片名：</label>
										<div class="form-group">
											 <div id="imgs">&nbsp;&nbsp;&nbsp;&nbsp;<img width="200px" src="/shop/Public/Home/index/images/<?php echo ($index['index_picname']); ?>"></div>
											<center><input id="file_upload" name="index_picname" type="file" multiple="true" value="<?php echo ($index[index_picname]); ?>" /></center>
											
										</div>
									</div>
                                   
									<input type="hidden" name="index_picname" value="<?php echo ($index['index_picname']); ?>"/>			
