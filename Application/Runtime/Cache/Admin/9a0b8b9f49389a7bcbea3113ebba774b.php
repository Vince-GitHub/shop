							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
                                        ...
                                        <form action="/shop/admin.php/Gdetail/del" method="post">
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
                                                    <?php if(is_array($gdetails)): foreach($gdetails as $key=>$gdetail): ?><tr>
														<td class="center">
															<label>
																<input type="checkbox" name="ids[]" value="<?php echo ($gdetail['gdetail_id']); ?>"  class="ace ids" />
																<span class="lbl"></span>
															</label>
														</td>

														
														<td><?php echo ($gdetail['gdetail_goodsid']); ?></td>
														<td><img width=60px height=60px src="/shop/Public/uploads/<?php echo ($gdetail['gdetail_picname1']); ?>"/></td>
														<td><img width=60px height=60px src="/shop/Public/uploads/<?php echo ($gdetail['gdetail_picname2']); ?>"/></td>
														<td><img width=60px height=60px src="/shop/Public/uploads/<?php echo ($gdetail['gdetail_picname3']); ?>"/></td>
														<td><img width=60px height=60px src="/shop/Public/uploads/<?php echo ($gdetail['gdetail_picname4']); ?>"/></td>
														<td><?php echo ($gdetail['gdetail_gnum']); ?></td>
														<td><?php echo ($gdetail['gdetail_texture']); ?></td>
														<td><?php echo ($gdetail['gdetail_pplace']); ?></td>
														<td><?php echo ($gdetail['gdetail_descr']); ?></td>
														<td><?php echo ($gdetail['gdetail_clean']); ?></td>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																...
																<a href="/shop/admin.php/Gdetail/mod/id/<?php echo ($gdetail['gdetail_id']); ?>" class="btn btn-xs btn-info">
																	<i class="icon-edit bigger-120"></i>
																</a>

																<a href="/shop/admin.php/Gdetail/del/ids/<?php echo ($gdetail['gdetail_id']); ?>"  class="btn btn-xs btn-danger">
