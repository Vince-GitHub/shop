									...
									<div class="col-xs-12">
										<div class="table-responsive">
											<table id="sample-table-1" class="table table-striped table-bdetailed table-hover">
												...
												<tbody>
												<!-- 遍历表内容并输出 -->
													<?php if(is_array($details)): foreach($details as $key=>$detail): ?><tr>
														<td class="center">
															<label>
																<input type="checkbox" class="ids ace" />
																<span class="lbl"></span>
														...
														<td><img width="70px" height="80px" src="/hszz/TP/Public/Uploads/<?php echo ($detail['detail_pic']); ?>"/></td>
														<td><?php echo ($detail['detail_price']); ?></td>
														<td><?php echo ($detail['detail_num']); ?></td>
														<td><?php echo ($detail['detail_total']); ?></td>
														<td><a href = "/hszz/TP/admin.php/GoodsComment/index/
														goodsid/<?php echo ($detail['detail_goodsid']); ?>">查看评论</a></td>
