...
<html lang="en">
	...
	<body>
		...
		<link rel="stylesheet" href="/shop/Public/uploadify.css">
        <script src='/shop/Public/jquery.js'></script>
        <script src='/shop/Public/jquery.uploadify.min.js'></script>
	<div class="main-content">
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form class="form-horizontal" action="/shop/admin.php/User/insert" enctype="multipart/form-data" method="post" role="form" >
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 账号 </label>

							<div class="col-sm-9">
								<input type="text" id="form-field-1" name="users_account"  placeholder="请输入用户名" class="col-xs-10 col-sm-5" />
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="form-field-1" name="users_name"  placeholder="请输入真实姓名" class="col-xs-10 col-sm-5" />
								<span class="help-inline col-xs-12 col-sm-7">
									<span class="middle">*</span>
								</span>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="password" id="form-field-2" name="users_pass" placeholder="请输入密码" class="col-xs-10 col-sm-5" />
								<span class="help-inline col-xs-12 col-sm-7">
									<span class="middle">*</span>
								</span>
							</div>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> 确认密码 </label>

							<div class="col-sm-9">
								<input type="password" id="form-field-2" name="repwd" placeholder="请再次输入密码" class="col-xs-10 col-sm-5" />
								<span class="help-inline col-xs-12 col-sm-7">
									<span class="middle">*</span>
								</span>
							</div>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-5">性　别</label>

							<div class="col-sm-9">
							
								<label>
									<input name="users_sex" class="ace" type="radio" value=1>
									<span class="lbl"> 男</span>
									
								</label>
								<label>
								<input name="users_sex" class="ace" type="radio" value=0>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-4">地 址</label>

							<div class="col-sm-9">
							<input type="text" id="form-field-2" name="users_address" placeholder="请输入地址" class="col-xs-10 col-sm-5" />
								<span class="help-inline col-xs-12 col-sm-7">
									<span class="middle">*</span>
								</span>	
							</div>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-4">邮　编</label>

							<div class="col-sm-9">
							<input type="text" id="form-field-2" name="users_code" placeholder="请输入邮编" class="col-xs-10 col-sm-5" />
								<span class="help-inline col-xs-12 col-sm-7">
									<span class="middle">*</span>
								</span>	
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
							<input type="text" id="form-field-2" name="users_phone" placeholder="请输入电话" class="col-xs-10 col-sm-5" />
								<span class="help-inline col-xs-12 col-sm-7">
									<span class="middle">*</span>
								</span>	
							</div>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-4">邮　箱</label>

							<div class="col-sm-9">
							<input type="email" id="form-field-2" name="users_email" placeholder="请输入邮箱" class="col-xs-10 col-sm-5" />
								<span class="help-inline col-xs-12 col-sm-7">
									<span class="middle">*</span>
								</span>	
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
							<input type="text" id="form-field-2" name="users_state" placeholder="请输入状态" class="col-xs-10 col-sm-5" />
								<span class="help-inline col-xs-12 col-sm-7">
									<span class="middle">*</span>
								</span>	
							</div>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-4">注册时间</label>

							<div class="col-sm-9">
							<input type="text" id="form-field-2" name="users_addtime" placeholder="请输入" class="col-xs-10 col-sm-5" />
								<span class="help-inline col-xs-12 col-sm-7">
									<span class="middle">*</span>
								</span>	
							</div>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-4">用户头像</label>
							<div id="imgs"><img width="100px" src="/shop/Public/uploads/images/552ca71a85f99.jpg"></div>
							<input id="file_upload" name="users_icon" type="file"  value="" />
						</div>
     ...
     <script>
		...
		$('#file_upload').uploadify({
	        	'swf'      : '/shop/Public/uploadify.swf',
	        	'uploader' : '<?php echo U("user/upload");?>',
	        	'buttonText' : '图片上传',
	        	'onUploadSuccess' : function(file, data, response) {
	        	
	        	 img += "<img width='100px' src='/shop/Public/Uploads/images/"+data+"'>";
	            $('#imgs').html(img);
	            //$('#images').val(data);
        	}
    	});
