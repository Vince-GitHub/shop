												...
												<!-- 遍历表内容并输出 -->
													<?php if(is_array($comments)): foreach($comments as $key=>$comment): ?><tr>
														...
														<td><img width="70px" height="80px"
															src="/shop/Public/Uploads/<?php echo ($comment['comments_goodspic']); ?>"></td>

														<td><?php echo ($comment['comments_title']); ?></td>
														<td><?php echo (date("Y-m-d H:i",$comment['comments_time'])); ?></td>
														<td><a href="/shop/admin.php/commentDetail/index/commentid/<?php echo ($comment["comments_id"]); ?>">查看评论内容</a></td>
