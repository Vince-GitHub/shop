								...
								<div class="row">
									<div class="col-xs-12">	
										<div class="table-responsive">
										 <form action="/hszz/TP/admin.php/Share/del" method="post">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<?php if(is_array($share)): foreach($share as $key=>$share): ?><tr>
														<td><?php echo ($share['share_userid']); ?></td>
														<td>
															<?php if(is_array($users)): foreach($users as $key=>$user): if($user['users_id'] == $share['share_userid'] ): echo ($user['users_name']); endif; endforeach; endif; ?>
														</td>
														<td class="hidden-480">
															<span class="label label-sm label-info arrowed arrowed-righ"><?php echo ($share['share_title']); ?></span>
														</td>
														<td class="hidden-480"><?php echo ($share['share_content']); ?></td>
														<td class="hidden-480">
															<span class="label label-sm label-success"><?php echo ($share['share_goodsid']); ?></span>
														</td>
														<td><?php echo (date("Y-m-d",$share['share_time'] )); ?>
														</td>
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="red" href="/hszz/TP/admin.php/Share/del/share_id/<?php echo ($share["share_id"]); ?>">
