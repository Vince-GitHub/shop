					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" action="/hszz/tp/admin.php/Notice/insert" method="post" role="form">
									<!--公告标题-->
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">公告标题：</label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="notice_title"  placeholder="请输入标题" class="col-xs-10 col-sm-5" />
                                        </div>
									</div>
										
									<!--公告详情-->
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">详 情：</label>

										<div class="col-sm-9">
											<textarea cols="20" rows="4" id="form-field-2" name="notice_descr" placeholder="请添加公告内容" class="col-xs-10 col-sm-5" ></textarea>
                                        </div>
									</div>									
