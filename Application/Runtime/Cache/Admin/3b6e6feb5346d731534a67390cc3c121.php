								...
								<div class="row">
									<div class="col-xs-12">	
										<div class="table-responsive">
										 <form action="/hszz/TP/admin.php/Type/del" method="post">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<?php if(is_array($type)): foreach($type as $key=>$type): ?><tr>
														<td><?php echo ($type['type_id']); ?></td>
														<td class="hidden-480">
															<?php if($type['type_pid'] == 0): ?><span class="label label-sm label-inverse arrowed-in">-----><?php echo ($type['type_name']); ?></span>
																<?php elseif($type['type_pid'] != 0): ?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<span class="label label-sm label-info arrowed arrowed-righ">-----><?php echo ($type['type_name']); ?></span><?php endif; ?>
														</td>
														<td class="hidden-480"><?php echo ($type['type_pid']); ?></td>
														<td class="hidden-480">
															<span class="label label-sm label-success"><?php echo ($type['type_path']); ?></span>
														</td>
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																&nbsp&nbsp&nbsp&nbsp
																<a class="blue" href="/hszz/TP/admin.php/Type/add/type_id/<?php echo ($type['type_id']); ?>">
																	<i class="icon-zoom-in bigger-130">&nbsp&nbsp添加子类</i>
																</a>&nbsp&nbsp丨&nbsp&nbsp

																<a class="green" href="/hszz/TP/admin.php/Type/mod/type_id/<?php echo ($type['type_id']); ?>">
																	<i class="icon-pencil bigger-130">&nbsp&nbsp编辑</i>
																</a>&nbsp&nbsp丨&nbsp&nbsp

																<a class="red" href="/hszz/TP/admin.php/Type/del/type_id/<?php echo ($type["type_id"]); ?>">
																	<i class="icon-trash bigger-130">&nbsp&nbsp删除</i>
																</a>
															</div>			
														</td>
													</tr>
