			...
			<div class="col-xs-12">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<form action="/shop/admin.php/User/del" method="post">
							<table id="sample-table-1" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									<?php if(is_array($users)): foreach($users as $key=>$user): ?><tr>
										<td class="center">
											<label>
												<input type="checkbox" name="ids[]" value="<?php echo ($user['users_id']); ?>"  class="ace ids" />
												<span class="lbl"></span>
											</label>
										</td>
										<td>
											<a href="#"><?php echo ($user['users_id']); ?></a>
										</td>
										<td><?php echo ($user['users_account']); ?></td>
										<td><?php echo ($user['users_name']); ?></td>
										<td>是</td>
										<td><?php echo ($user['users_sex']); ?></td>
										<td><?php echo ($user['users_address']); ?></td>
										<td><?php echo ($user['users_code']); ?></td>
										<td><?php echo ($user['users_phone']); ?></td>
										<td><?php echo ($user['users_email']); ?></td>
										<?php switch($user['users_state']): case "0": ?><td>启用</td><?php break;?>
											<?php case "1": ?><td>禁用</td><?php break; endswitch;?>
									
										<td><?php echo ($user['users_addtime']); ?></td>
										<td><img src="/shop/Public/Uploads/<?php echo ($user['users_icon']); ?>" width="60px" height="60px"/></td>
											...
											<td><div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
												...
												<a href="/shop/admin.php/User/mod/id/<?php echo ($user['users_id']); ?>" class="btn btn-xs btn-info">
													<i class="icon-edit bigger-120"></i>
												</a>

												<a href="/shop/admin.php/User/del/ids/<?php echo ($user['users_id']); ?>"  class="btn btn-xs btn-danger">
