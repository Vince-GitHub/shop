			...
			<div class="col-xs-12">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<form action="/shop/admin.php/Grade/del" method="post">
							<table id="sample-table-1" class="table table-striped table-bordered table-hover">
								...
								<tbody>
								    <?php if(is_array($grades)): foreach($grades as $key=>$grade): ?><tr>
									    
										<td>
											<a href=""><?php echo ($grade['grade_id']); ?></a>
										</td>
										<td>
											<a href=""><?php if(is_array($users)): foreach($users as $key=>$user): if($user['users_id'] == $grade['grade_userid']): echo ($user['users_id']); endif; endforeach; endif; ?></a>
										</td>
										<td><?php if(is_array($users)): foreach($users as $key=>$user): if($user['users_id'] == $grade['grade_userid']): echo ($user['users_account']); endif; endforeach; endif; ?></td>
										<td><?php if(is_array($users)): foreach($users as $key=>$user): if($user['users_id'] == $grade['grade_userid']): echo ($user['users_name']); endif; endforeach; endif; ?></td>
										<td><?php echo ($grade['grade_score']); ?></td>
										<td><?php if($grade['grade_score'] < 1000): ?><img src='/shop/Public/Level/1level.jpg' style="width:10px"/><?php elseif($grade['grade_score'] < 2000 ): ?><img src='/shop/Public/Level/1level.jpg' style="width:10px"/><img src='/shop/Public/Level/1level.jpg' style="width:10px"/><?php elseif($grade['grade_score'] < 4000): ?><img src='/shop/Public/Level/2level.jpg' style="width:10px"/><?php elseif($grade['grade_score'] < 8000): ?><img src='/shop/Public/Level/2level.jpg' style="width:10px"/><img src='/shop/Public/Level/1level.jpg' style="width:10px"/><?php elseif($grade['grade_score'] < 12000): ?><img src='/shop/Public/Level/2level.jpg' style="width:10px"/><img src='/shop/Public/Level/1level.jpg' style="width:10px"/><img src='/shop/Public/Level/1level.jpg' style="width:10px"/><?php elseif($grade['grade_score'] < 16000): ?><img src='/shop/Public/Level/2level.jpg' style="width:10px"/><img src='/shop/Public/Level/2level.jpg' style="width:10px"/><?php elseif($grade['grade_score'] < 22000): ?><img src='/shop/Public/Level/3level.jpg' style="width:10px"/><?php elseif($grade['grade_score'] < 28000): ?><img src='/shop/Public/Level/3level.jpg' style="width:10px"/><img src='/shop/Public/Level/1level.jpg' style="width:10px"/><?php elseif($grade['grade_score'] < 36000): ?><img src='/shop/Public/Level/3level.jpg' style="width:10px"/><img src='/shop/Public/Level/1level.jpg' style="width:10px"/><img src='/shop/Public/Level/1level.jpg' style="width:10px"/><?php elseif($grade['grade_score'] < 42000): ?><img src='/shop/Public/Level/3level.jpg' style="width:10px"/><img src='/shop/Public/Level/2level.jpg' style="width:10px"/><?php elseif($grade['grade_score'] < 48000): ?><img src='/shop/Public/Level/3level.jpg' style="width:10px"/><img src='/shop/Public/Level/2level.jpg' style="width:10px"/><img src='/shop/Public/Level/1level.jpg' style="width:10px"/><?php elseif($grade['grade_score'] < 58000): ?><img src='/shop/Public/Level/3level.jpg' style="width:10px"/><img src='/shop/Public/Level/2level.jpg' style="width:10px"/><img src='/shop/Public/Level/1level.jpg' style="width:10px"/><img src='/shop/Public/Level/1level.jpg' style="width:10px"/><?php elseif($grade['grade_score'] < 70000): ?><img src='/shop/Public/Level/3level.jpg' style="width:10px"/><img src='/shop/Public/Level/2level.jpg' style="width:10px"/><img src='/shop/Public/Level/2level.jpg' style="width:10px"/><?php else: ?><img src='/shop/Public/Level/3level.jpg' style="width:10px"/><img src='/shop/Public/Level/3level.jpg' style="width:10px"/><?php endif; ?></td>
											<td><div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
												

												<a href="/shop/admin.php/Grade/mod/id/<?php echo ($grade['grade_id']); ?>" class="btn btn-xs btn-info">
													<i class="icon-edit bigger-120"></i>修改积分
												</a>
