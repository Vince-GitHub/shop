					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" action="/hszz/TP/admin.php/Flink/update" method="post" role="form">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 链接名 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="Flink_name"  value="<?php echo ($links['Flink_name']); ?>" class="col-xs-10 col-sm-5" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="Flink_url"  value="<?php echo ($links['Flink_url']); ?>" class="col-xs-10 col-sm-5" />
                                            <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">*</span>
											</span>
                                        </div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select name="Flink_status">
												<option <?php echo ($links['Flink_status']==0?"selected":" "); ?> value="0">未展示</option>
												<option <?php echo ($links['Flink_status']==1?"selected":" "); ?> value="1">已展示</option>
												<option <?php echo ($links['Flink_status']==2?"selected":" "); ?> value="2">无效链接</option>
											</select>
								...
								<input type="hidden" name="Flink_id" value=
								"<?php echo ($links['Flink_id']); ?>" />
