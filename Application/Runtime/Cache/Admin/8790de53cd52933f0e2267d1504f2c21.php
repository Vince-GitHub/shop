					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="/hszz/TP/admin.php">Home</a>
							</li>
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<form action="/hszz/TP/admin.php/History/index" method="post">
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												
												
                                                    
													<?php if(is_array($historys)): foreach($historys as $key=>$history): ?><tr>  
														<td width="100px">
															<a href="#"><?php echo ($history['history_name']); ?></a>
															
														</td>
														<td >
															<a href="#"><?php echo ($history['history_picname']); ?></a>
														</td>
														<td width="850">
															<img src="/hszz/TP/Public/Home/History/images/<?php echo ($history['history_picname']); ?>" width="840px"/>
														</td>
														<td width="45">
															<center>
															<a class="green" href="/hszz/TP/admin.php/History/mod/history_id/<?php echo ($history['history_id']); ?>">
																<i class="icon-pencil bigger-130" title="编辑"><br/>修<br/>改<br/>图<br/>片<br/></i>
															</a>
															</center>
														</td>
