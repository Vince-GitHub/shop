							...
							<div class="col-xs-12">
								...
								<div class="alert alert-block alert-success">
									...
									,轻量级好用的后台管理系统模版.	
										...
										<form action="/shop/admin.php/Index/index" method="post">
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												
													<?php if(is_array($indexs)): foreach($indexs as $key=>$index): ?><tr>  
														<td width="80px">
															<a href="#"><?php echo ($index['index_name']); ?></a>
															
														</td>
														<td width="80px">
															<a href="#"><?php echo ($index['index_picname']); ?></a>
														</td>
														<td width="500">
															<img src="/shop/Public/Home/index/images/<?php echo ($index['index_picname']); ?>" width="500px"/>
														</td>
														<td width="45">
															<center>
															<a class="green" href="/shop/admin.php/Index/mod/index_id/<?php echo ($index['index_id']); ?>">
