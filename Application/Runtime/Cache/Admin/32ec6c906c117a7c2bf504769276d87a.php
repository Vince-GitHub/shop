						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="white">风尚	VIPLUX</span>
								</h1>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action="/shop/admin.php/Login/login" method="post">
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" name="admins_account" placeholder="用户名" />
															<i class="icon-user"></i>
														</span>
													</label>
