					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" action="/hszz/TP/admin.php/Type/insert" method="post" role="form">
								
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 父 类 别 名 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="type_name"  readonly  value="<?php echo ($type['type_name']==false ? 跟类别:$type['type_name']); ?>" class="col-xs-10 col-sm-5" />
                                            <span class="help-inline col-xs-12 col-sm-7">
											</span>
                                        </div>
									</div>
										
										<input type="hidden" name="type_pid" value="<?php echo ($type['type_id']); ?>"/>
										<input type="hidden" name="type_path" value="<?php echo ($type['type_path']); echo ($type['type_id']); ?>,"/>
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 类 别 名 称 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="type_name"  class="col-xs-10 col-sm-5" />
                                        </div>
									</div>									
