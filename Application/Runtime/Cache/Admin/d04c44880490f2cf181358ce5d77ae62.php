											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th><i class="icon-time bigger-110 hidden-480"></i>用户 ID:</th>
														<th class="hidden-480">用户名称:</th>
														<th class="hidden-480">商品 ID:</th>
														<th>商品名称:</th>
														<th class="hidden-480">商品图片:</th>
														<th class="hidden-480">收藏时间:</th>
													</tr>
												</thead>
												
												<tbody>
												<?php if(is_array($collects)): foreach($collects as $key=>$collect): ?><tr>
														<td class="center">
															<label>
																<input type="checkbox" class="ace" />
																<span class="lbl"></span>
														...
														<td>
															<a href="#"><?php echo ($collect['collect_userid']); ?></a>
														</td>
													
													<!--根据id去用户表查询用户id-->
														<td>
														<?php if(is_array($users)): foreach($users as $key=>$user): if($collect['collect_userid'] == $user['users_id'] ): echo ($user['users_name']); endif; endforeach; endif; ?>
														</td>
														<td class="hidden-480"><?php echo ($collect['collect_goodsid']); ?></td>
													
													<!--根据商品id去商品表查询商品名称和图片-->
														<td>
														<?php if(is_array($goods)): foreach($goods as $key=>$good): if($good['goods_id'] == $collect['collect_goodsid'] ): echo ($good['goods_goods']); ?>
														</td>
														
														<td>
																<img width=60px height=60px src="/hszz/TP/Public/uploads/<?php echo ($good['goods_picname']); ?>"/><?php endif; endforeach; endif; ?>
														</td>
														<td class="hidden-480">
															<span class="label label-sm label-warning"><?php echo (date("Y-m-d",$collect['collect_time'] )); ?></span>
														</td>
