											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th class="hidden-480">所在地区:</th>
														<th>街 道:</th>
														<th class="hidden-480">详细地址:</th>
														<th class="hidden-480">收件人姓名:</th>
														<th class="hidden-480">收件人手机号:</th>
														<th>邮 编:</th>
														<th>操 作:</th>
													</tr>
												</thead>
												...
												<tbody>
												<?php if(is_array($profiles)): foreach($profiles as $key=>$profile): ?><tr>
														<td class="center">
															<label>
																<input type="checkbox" class="ace" />
																<span class="lbl"></span>
														...
														<td>
															<a href="#"><?php echo ($profile['profile_id']); ?></a>
														</td>
														<td><?php echo ($profile['profile_userid']); ?></td>
														<td class="hidden-480"><?php echo ($profile['profile_region']); ?></td>
														<td><?php echo ($profile['profile_street']); ?></td>
														<td><?php echo ($profile['profile_address']); ?></td>
														<td class="hidden-480">
															<span class="label label-sm label-warning"><?php echo ($profile['profile_name']); ?></span>
														</td>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																<!--编辑-->
																<a href="/hszz/TP/admin.php/Profiles/mod/profile_id/<?php echo ($profile['profile_id']); ?>" class="btn btn-xs btn-info" title="修改信息">
																	<i class="icon-edit bigger-120"></i>
																</a>
																<!--删除-->
																<a href="/hszz/TP/admin.php/Profiles/del/profile_id/<?php echo ($profile['profile_id']); ?>"  class="btn btn-xs btn-danger" title="删除用户">
