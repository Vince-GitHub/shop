			...
			<div class="col-xs-12">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<form action="/shop/admin.php/Admin/del" method="post">
							<table id="sample-table-1" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									<?php if(is_array($admins)): foreach($admins as $key=>$admin): ?><tr>
										<td class="center">
											<label>
												<input type="checkbox" name="ids[]" value="<?php echo ($admin['admins_id']); ?>"  class="ace ids" />
												<span class="lbl"></span>
											</label>
										</td>
										<td><?php echo ($admin['admins_id']); ?></td>
										<td><?php echo ($admin['admins_account']); ?></td>
										<td><?php echo ($admin['admins_name']); ?></td>
										<td>是</td>
										<td><?php echo ($admin['admins_sex']); ?></td>
										<td><?php echo ($admin['admins_age']); ?></td>
										<td><?php echo ($admin['admins_phone']); ?></td>
										<?php switch($admin['admins_status']): case "0": ?><td>启用</td><?php break;?>
											<?php case "1": ?><td>禁用</td><?php break; endswitch;?>
									
										<td><img src="/shop/Public/Uploads/<?php echo ($admin['admins_icon']); ?>" width="60px" height="60px"/></td>
											...
											<td><div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
												...
												<a href="/shop/admin.php/Admin/mod/id/<?php echo ($admin['admins_id']); ?>" class="btn btn-xs btn-info">
													<i class="icon-edit bigger-120"></i>
												</a>

												<a href="/shop/admin.php/Admin/del/ids/<?php echo ($admin['admins_id']); ?>"  class="btn btn-xs btn-danger">
