					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" action="/hszz/TP/admin.php/Admin/update"  
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="admins_account"  value="<?php echo ($admin['admins_account']); ?>" readonly placeholder="请输入用户名" class="col-xs-10 col-sm-5" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="admins_name" value="<?php echo ($admin['admins_name']); ?>" placeholder="请输入真实姓名" class="col-xs-10 col-sm-5" />
                                            <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">*</span>
											</span>
                                        </div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
												...
												<label>
													<input name="admins_sex" class="ace" type="radio" 
													<?php echo ($admin['admins_sex']==1?'checked':' '); ?> value=1>
													<span class="lbl"> 男</span>  
												</label>
												<label>
													<input name="admins_sex" class="ace" type="radio" 
													<?php echo ($admin['admins_sex']==0?'checked':' '); ?> value=0>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
												...
												<label>
													<input name="admins_status" class="ace" type="radio" 
													<?php echo ($admin['admins_sex']==1?'checked':' '); ?> value=1>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										<input type="text" id="form-field-2" name="admins_address" value="<?php echo ($admin['admins_age']); ?>" placeholder="请输入年龄" class="col-xs-10 col-sm-5" />
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">*</span>
											</span>	
                                        </div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										<input type="text" id="form-field-2" name="admins_phone"value="<?php echo ($admin['admins_phone']); ?>" placeholder="请输入电话" class="col-xs-10 col-sm-5" />
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">*</span>
											</span>	
                                        </div>
									...
									<div class="form-group">
										...
										<div id="imgs"><img width="160px" src="/hszz/TP/Public/uploads/<?php echo ($admin['admins_icon']); ?>"></div>
									...
									<input type="hidden" name="admins_id" value="<?php echo ($admin['admins_id']); ?>"/>
									<div class="space-4"></div>
