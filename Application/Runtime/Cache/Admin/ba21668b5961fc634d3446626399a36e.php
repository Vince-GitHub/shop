					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" action="/hszz/TP/admin.php/History/update" method="post" role="form" enctype="multipart/form-data">
...
、
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2" name="history_name" value="<?php echo ($history[history_name]); ?>" class="col-xs-10 col-sm-5" readonly/>
									...
									<div class="form-group">
											 <div id="imgs">&nbsp;&nbsp;&nbsp;&nbsp;<img width="200px" src="/hszz/TP/Public/Home/History/images/<?php echo ($history['history_picname']); ?>"></div>
											<center><input id="file_upload" name="history_picname" type="file" multiple="true" value="<?php echo ($history[history_picname]); ?>" /></center>
											
										</div>
										<input type="hidden" name="oldpicname" value="<?php echo ($history['history_picname']); ?>"/>
									</div>
