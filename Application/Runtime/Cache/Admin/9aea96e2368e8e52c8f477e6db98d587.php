							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
                                        ...
                                        <form action="/shop/admin.php/Flink/add" method="post">
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<?php if(is_array($links)): foreach($links as $key=>$link): ?><tr>
														...
														<td><?php echo ($link['Flink_id']); ?></td>
														<td><?php echo ($link['Flink_name']); ?></td>
														
													<!-- 根据订单状态不同显示不同信息 -->
													<?php switch($link['Flink_status']): case "0": ?><td>未展示</td><?php break;?>
														<?php case "1": ?><td>已展示</td><?php break;?>
														<?php case "2": ?><td>无效链接</td><?php break; endswitch;?>
													<!-- <td><?php echo ($link['links_status']); ?></td> -->

														<td><?php echo ($link['Flink_url']); ?></td>
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																...
																<a href="/shop/admin.php/Flink/mod/id/<?php echo ($link['Flink_id']); ?>" class="btn btn-xs btn-info">
																	<i class="icon-edit bigger-120"></i>修改
																</a>

																<a href="/shop/admin.php/Flink/del/id/<?php echo ($link["Flink_id"]); ?>"  class="btn btn-xs btn-danger">
