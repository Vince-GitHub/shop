					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" action="/hszz/TP/admin.php/User/update"  
									enctype="multipart/form-data" method="post" role="form">
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 账	号 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="users_account"  value="<?php echo ($user['users_account']); ?>" readonly placeholder="请输入用户名" class="col-xs-10 col-sm-5" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="users_name" value="<?php echo ($user['users_name']); ?>" placeholder="请输入真实姓名" class="col-xs-10 col-sm-5" />
                                            <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">*</span>
											</span>
                                        </div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
												...
												<label>
													<input name="users_sex" class="ace" type="radio" 
													<?php echo ($user['users_sex']==1?'checked': ''); ?> value=1 >
													<span class="lbl"> 男</span>  
												</label>
												
												<label>
													<input name="users_sex" class="ace" type="radio" 
													<?php echo ($user['users_sex']==0?'checked': ''); ?> value=0>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										<input type="text" id="form-field-2" name="users_address" value="<?php echo ($user['users_address']); ?>" placeholder="请输入地址" class="col-xs-10 col-sm-5" />
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">*</span>
											</span>	
                                        </div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										<input type="text" id="form-field-2" name="users_code" value="<?php echo ($user['users_code']); ?>" placeholder="请输入邮编" class="col-xs-10 col-sm-5" />
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">*</span>
											</span>	
                                        </div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-4">电	话</label>

										<div class="col-sm-9">
										<input type="text" id="form-field-2" name="users_phone"value="<?php echo ($user['users_phone']); ?>" placeholder="请输入电话" class="col-xs-10 col-sm-5" />
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">*</span>
											</span>	
                                        </div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										<input type="email" id="form-field-2" name="users_email"value="<?php echo ($user['users_email']); ?>" placeholder="请输入邮箱" class="col-xs-10 col-sm-5" />
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">*</span>
											</span>	
                                        </div>
									...
									<div class="form-group">
										...
										<div id="imgs"><img width="160px" src="/hszz/TP/Public/uploads/<?php echo ($user['users_icon']); ?>"></div>
									...
									<script>
											...
											$('#file_upload').uploadify({
													...
													'uploader' : '<?php echo U("mod/upload");?>',
													'buttonText' : '图片上传',
