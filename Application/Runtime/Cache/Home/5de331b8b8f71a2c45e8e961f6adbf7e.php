...
<div class="shopping">
    ...
    <link href="/shop/Public/Home/History/css/ResourceHandler_005.css" rel="stylesheet" type="text/css">
    <link href="/shop/Public/Home/History/css/ResourceHandler_002.css" rel="Stylesheet" type="text/css">
    <link href="/shop/Public/Home/History/css/ResourceHandler.css" rel="Stylesheet" type="text/css">
    <link href="/shop/Public/Home/History/css/ResourceHandler_006.css" rel="Stylesheet" type="text/css">
    <link href="/shop/Public/Home/History/css/ResourceHandler_007.css" rel="Stylesheet" type="text/css">
    <!-- end head css -->
    <!-- 自定义CSS-->
    <script type="text/javascript">
        ...
        if (browser.versions.mobile && !browser.versions.iPad) {
            ...
            if (pathname.indexOf("/product/") > -1) {
                var result = /product\/(\d+)/.exec(pathname);
                if (result != "") {
...
<body id="brandbodyID">
    <input id="NewShangpinLoginDomainUrl"  type="hidden">
    <input id="NewShangpinTradeDomainUrl"  type="hidden">
    <input id="NewShangpinDomainUrl"  type="hidden">
    <input id="NewShangpinAccountDomainUrl"  type="hidden">
    <input id="NewAoLaiTradeDomainUrl"  type="hidden">
    <!--页头倒计时-->
    <input id="IndexCmsContentAD" name="IndexCmsContentAD" value="" type="hidden">
...
<div class="sp_banner">
    <div class="img_banner">
        <img src="/shop/Public/Home/History/images/bg_top01.jpg" width="1900" height="223">
        <img src="/shop/Public/Home/History/images/bg_top02.jpg" width="1900" height="223">
    </div>
    <div class="top_menu">
        <ul>
            <li><a href="" target="_blank">商品浏览</a>
            </li>
            <li><a href="" target="_blank">跨界合作</a> </li>
            <li><a href="" target="_blank">明星演绎</a> </li>
            <li><a href="" target="_blank">品牌历史</a> </li>
        </ul>
    </div>
</div>
<!--头部大图片end -->
<div class="sp_activity sp_activity01">
    
	<dl class="clr">
        <div class="box_video">
			<object id="sp-video" name="spVideo" width="605" height="330">
			<param name="src" ><param name="quality" value="high">
			<param name="wmode" value="transparent">
			</object>
				<div class="sp-video-mask" name="sp_videoMask" style="width: 605px; height: 330px; position: absolute; display: none;">
				</div>
		</div>
        
		
		<?php if(is_array($historys)): foreach($historys as $key=>$history): ?><img src="/shop/Public/Home/History/images/<?php echo ($history['history_picname']); ?>" width="964"/><?php endforeach; endif; ?>   
			
			<img src="/shop/Public/Home/History/images/history_29.jpg" width="964"/>
