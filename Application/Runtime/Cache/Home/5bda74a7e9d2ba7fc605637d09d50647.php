...
<div id="member_right" class="flt">
    ...
    <h2>用户收货地址管理   <a href="/hszz/TP/index.php/profiles/add" class="mobiapp">+ 添加新地址</a></h2>
        ...
        <div class="member_content" id="spTabs_content">
                <!-- Start -->
                 <table class="prodList" width="800px">
							...
							<tbody>
                            <!-- 遍历表内容并输出 -->
                            <?php if(is_array($profiles)): foreach($profiles as $key=>$profile): if($_SESSION['user']['users_id'] == $profile['profile_userid']): ?><tr style="border-bottom:1px solid #ccc">									
										
										<!--所在地区-->
										<td><?php echo ($profile['profile_region']); ?></td>
										
										<!--街道-->
										<td><?php echo ($profile['profile_street']); ?></td>
										...
										<!--操作-->
										<td>
											<a href="/hszz/TP/index.php/profiles/del/profile_id/<?php echo ($profile['profile_id']); ?>">删除</a>丨
											<a href="/hszz/TP/index.php/profiles/mod/profile_id/<?php echo ($profile['profile_id']); ?>">修改</a>
										</td>
