...
<div class="shopping">
    ...
    <script src="/hszz/TP/Public/HOME/myOrder/ntkfstat5.js" charset="utf-8" async="" type="text/javascript"></script>
    <script src="/hszz/TP/Public/HOME/myOrder/ResourceHandler_009.js" type="text/javascript"></script>
 
    <script src="" type="text/javascript" charset="utf-8"></script>
  
    <script src="/hszz/TP/Public/HOME/myOrder/semwl.js" type="text/javascript"></script>
    <script type="text/javascript" src="/hszz/TP/Public/HOME/myOrder/seo.htm"> </script>
    ...
    <script charset="utf-8" src="/hszz/TP/Public/HOME/myOrder/kf_9986_kf_9986_1355827406710.js" async="" type="text/javascript"></script>
    <script charset="utf-8" src="/hszz/TP/Public/HOME/myOrder/userinfo.php" async="" type="text/javascript"></script>
    <script charset="utf-8" src="/hszz/TP/Public/HOME/myOrder/ntchat.js" async="" type="text/javascript"></script>
...
<div id="member_left" class="flt">
    <div class="member_leftMenu">
        ...
        <ul>
           ...
           <li><a id="ChangePwd" href="/hszz/TP/index.php/Collect/repass">修改密码</a></li>
        </ul>
...
<div id="member_right" class="flt">
    ...
    <h2>
        我的收藏<a href="" class="mobiapp">手机客户端，随时随地查看物流信息</a>
    </h2>
    ...
    <div id="spTabs">
        ...
        <div class="member_content" id="spTabs_content">
                <!-- 暂无数据 Start -->
                 <table class="prodList" width="800px">
                            <colgroup>
                                <col width="250">
                                <col width="200">
                                <col width="200">
							...
							<tbody>
                            <!-- 遍历表内容并输出 -->
                            <?php if(is_array($collects)): foreach($collects as $key=>$collect): if($_SESSION['user']['users_id'] == $collect['collect_userid']): ?><tr style="border-bottom:1px solid #ccc">									
										
										<!--根据商品ID查看商品名称-->
										<td><?php if(is_array($goods)): foreach($goods as $key=>$good): if($good['goods_id'] == $collect['collect_goodsid'] ): echo ($good['goods_goods']); ?></td>
										
										<!--根据商品ID查看商品图片-->
										<td><img width=60px height=60px src="/hszz/TP/Public/uploads/<?php echo ($good['goods_picname']); ?>"/><?php endif; endforeach; endif; ?></td>
										
										<!--收藏时间-->
										<td><?php echo (date("Y-m-d H:i",$collect['collect_time'])); ?></td>
										<td><a href="/hszz/TP/index.php/Collect/del/collect_id/<?php echo ($collect['collect_id']); ?>">删除收藏</a></td>
