...
<form action="/hszz/TP/index.php/share/insert" id="accountfrom" method="post" name="accountfrom">        
                ...
                <div tabcontent="mytab-1" class="member_tebcell">
                    ...
                    <div id="member_userinfo" class="clr">
                        <div id="member_user_content">
							...
							<input type="hidden" name="share_goodsid" value="<?php echo ($goods['goods_id']); ?>">	
                            <div id="spAccount-myinfo_form" class="clr">
								...
								<dl>
                                    ...
                                    <dd>
                                        <span>
                                            <input value="<?php echo ($goods['goods_goods']); ?>"  readonly id="info_mobile"  type="text">
                                        </span>
                                    </dd>
                                </dl>
                                <dl></dl>
                                    <dt><em></em>商品图片：</dt>
                                        ...
                                        <img  width="100" src="/hszz/TP/Public/uploads/<?php echo ($goods['goods_picname']); ?>" />
								...
								<dl>
                                    ...
                                    <dd>
                                        <span>
                                            <input name="share_title"  id="info_mobile"  type="text">
                                        </span>
                                    </dd>
                                </dl>
								<dl></dl>
							<div>
                                    ...
                                    <dt><em>*</em>分享内容：</dt>
										...
										<textarea id="form-field-2" class="col-xs-10 col-sm-5" placeholder="请添加分享内容" name="share_content" rows="3" cols="33"></textarea>
                            </div>   								
