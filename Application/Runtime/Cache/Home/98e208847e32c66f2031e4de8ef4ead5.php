...
<div class="shopping">
	...
	<link rel="stylesheet" type="text/css" href="/hszz/TP/Public/Home/List/css/vl-category.css">
	<link rel="stylesheet" type="text/css" href="/hszz/TP/Public/Home/List/css/comm.css">
	<link rel="stylesheet" type="text/css" href="/hszz/TP/Public/Home/List/css/vl-global.css">
	<link rel="stylesheet" type="text/css" href="/hszz/TP/Public/Home/List/css/vl-common.css">
<!-- 正文内容 开始 -->
<body class="middleSize">
	<script type="text/javascript" src="/hszz/TP/Public/Home/List/js/vl-category.js"></script>
<script type="text/html" id="nav_shopping_tmp">
<div class="shopping">
		<div class="shopping-list">
	    <ul>
    ...
    <div class="container main">
        ...
        <div class="row search-result">
            <div class="nav">
                <a href="#product">产品（<?php echo ($goodss['counts']); ?>）</a>
               
              
            </div>
            <div class="space-bar"></div>
            <a id="product"></a>
            <h4>产品<small>（<a href="###">共有<?php echo ($goodss['counts']); ?>个结果</a>）</small></h4>
            <table class="table">
                <tbody>
                    <ul class="items">
    <?php if(is_array($goodss['goods'])): foreach($goodss['goods'] as $key=>$goods): ?><li>
	              <div class="item">
	                <div class="img-box" >
	                  <div class="normal"><a target="_blank" href="/hszz/TP/index.php/Gdetail/index/id/<?php echo ($goods['goods_id']); ?>"><img src="/hszz/TP/Public/uploads/<?php echo ($goods['goods_picname']); ?>" alt="<?php echo ($goods['goods_goods']); ?>" title="<?php echo ($goods['goods_goods']); ?>"></a></div>
	                  <div class="hover"><a target="_blank" href="/hszz/TP/index.php/Gdetail/index/id/<?php echo ($goods['goods_id']); ?>"><img src="/hszz/TP/Public/uploads/<?php echo ($goods['goods_picname2']); ?>" alt="<?php echo ($goods['goods_goods']); ?>" title="<?php echo ($goods['goods_goods']); ?>"></a></div>
	                ...
	                <p class="name"><a title="<?php echo ($goods['goods_goods']); ?>" target="_blank" href="/hszz/TP/index.php/Gdetail/index/id/<?php echo ($goods['goods_id']); ?>"><?php echo ($goods['goods_goods']); ?></a></p>
	                                  <div class="info no-login"><del>￥<?php echo ($goods['goods_price']); ?></del><span class="tip">查看VIP价</span></div>
                  	</div>
	            </li><?php endforeach; endif; ?>
		 </ul>
                    <tr>
                        <td colspan="4">
                            <a class="check-more" href="###">查看更多关于“<?php echo ($keyword); ?>”的产品</a>
                        </td>
                    </tr>
                </tbody>
            </table>
