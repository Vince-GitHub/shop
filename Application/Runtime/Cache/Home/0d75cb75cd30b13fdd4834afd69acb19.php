...
<div class="box" id="sp_newHeader">
    ...
    <div id="sp-header-midbar" class="clr">
        ...
        <ul id="sp_newHeader_loginForm" class="frt">
            <li>欢迎<span><?php echo ($_SESSION['user']['users_name']); ?></span>，
            <a href="/hszz/TP/index.php/Login/out" title="退出">[退出]</a></li>
        </ul>
...
<div id="member_left" class="flt">
    <div class="member_leftMenu">
        ...
        <ul>
           ...
           <li><a id="ChangePwd" href="/hszz/TP/index.php/Detail/repass">修改密码</a></li>
        </ul>
...
<div id="member_right" class="flt">
    ...
    <h2>
        我的订单<a href="" class="mobiapp">手机客户端，随时随地查看物流信息</a>
    </h2>
    ...
    <div id="spTabs">
        ...
        <div class="member_content" id="spTabs_content">
             ...
             <table class="prodList" border="0" cellpadding="0" cellspacing="0">
                ...
                <tbody>
                <!-- 遍历表内容并输出 -->
						<?php if(is_array($details)): foreach($details as $k=>$detail): ?><tr style="border-bottom:1px solid #ccc">
							<td><?php echo ($detail['detail_id']); ?></td>
                            <td><?php echo ($detail['detail_orderid']); ?></td>
                            <td><?php echo ($detail['detail_goodsid']); ?></td>
                            <td><?php echo ($detail['detail_name']); ?></td>
                            <td><img width="80px" height="90px" src="/hszz/TP/Public/Uploads/<?php echo ($detail['detail_pic']); ?>"/></td>
                            <td><?php echo ($detail['detail_price']); ?></td>
                            <td><?php echo ($detail['detail_num']); ?></td>
                            <td><?php echo ($detail['detail_total']); ?></td>
                                            
							<td>
								<span class="send" style="background-color:#c2c2c2">发表评论</span>
							</td>
						</tr>
						
						<tr style="display:none" class="none">
						
							<form action="/hszz/TP/index.php/Comments/insert" method="post">

								<input type="hidden" name="goodsid" 
									value="<?php echo ($detail['detail_goodsid']); ?>"/>
								<input type="hidden" name="goodspic" 
									value="<?php echo ($detail['detail_pic']); ?>"/>

		                        <th style="width:30px">标<br> &nbsp;&nbsp;&nbsp;题：</th>

		                        <td>
		                        	<textarea rows="3" cols="9" name="title"></textarea>
		                        </td>

		                        <th>内<br> &nbsp;&nbsp;&nbsp;容：</th>

		                        <td>
		                        	<textarea rows="3" cols="88" name="content"></textarea>
		                        </td>

								<th>
									<input type="submit" value="发  表" style="background-color:#d2a6c7;"><br/>
									<input type="reset" value="重  置" style="background-color:#d2a6c7;">
								</th>
		                    </form>
