...
<div id="member_left" class="flt">
    <div class="member_leftMenu">
        ...
        <h6>分享与关注</h6>
        <ul>
            <li><a id="FavoriteBrand" href="/hszz/TP/index.php/Share/detail">我的分享</a></li>
        </ul>
        ...
        <ul>
           ...
           <li><a id="ChangePwd" href="/hszz/TP/index.php/MyCenter/repass">修改密码</a></li>
        </ul>
...
<form action="/hszz/TP/index.php/MyCenter/update" enctype="multipart/form-data" id="accountfrom" method="post" name="accountfrom" >        
            ...
            <div class="member_content" id="spTabs_content">
                <div tabcontent="mytab-1" class="member_tebcell">
                    ...
                    <div id="member_userinfo" class="clr">
                        ...
                        <div id="member_userphoto">
                            <a href="javascript:;">
                                <img src="/hszz/TP/Public/uploads/<?php echo ($user['users_icon']); ?>" height="100" width="100"></a> <a class="weibo" href="">
						...
						<input type="hidden" name="users_id" value="<?php echo ($user['users_id']); ?>">
                                <dl>
                                    <dt><em>*</em> 账号：</dt>
                                    <dd><?php echo ($user['users_account']); ?></dd>
                                </dl>
								...
								<dl>
                                    ...
                                    <dd>
                                        <span>
                                            <input name="users_name" id="info_usernickname" value="<?php echo ($user['users_name']); ?>"type="text"/>
                                        </span>
                                    </dd>
                                </dl>
                                ...
                                <dl id="mobilearea">
                                    <dt>用户头像：</dt>
                                                ...
                                                <input id="file_upload" name="users_icon" type="file" multiple="true" value="<?php echo ($user[users_icon]); ?>" />
												<input type="hidden" name="oldpic" value="<?php echo ($user[users_icon]); ?>">
							    ...
							    <dl>
                                    ...
                                    <dd>
                                        <span>
                                            <input name="users_address" id="info_usernickname" value="<?php echo ($user['users_address']); ?>"type="text"/>
                                        </span>
                                    </dd>
                                </dl>  
								...
								<dl id="mobilearea">
                                    ...
                                    <dd>
                                        <span>
                                                <input name="users_phone" value="<?php echo ($user['users_phone']); ?>" id="info_mobile"  type="text">

                                        </span>
                                        <div>
                                                <em class="ac_green phone_hastest">已绑定</em><a href="javascript:;" id="changemobile">修改绑定手机</a>
                                        </div>
                                    </dd>
                                </dl>
                                <dl id="emailarea">
                                    ...
                                    <dd>
                                        <span>
                                            <input name="users_email" value="<?php echo ($user[users_email]); ?>" id="info_email" readonly="readonly" type="text">
                                        </span>
                                        <div>
                                                <em class="email_notest">未绑定</em><a href="javascript:;" id="bindemail1">绑定电子邮箱</a>
                                        </div>
                                    </dd>
                                </dl>
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        <span>
                                            <input name="users_code" value="<?php echo ($user['users_code']); ?>" id="info_code" type="text">
                                        </span>
                                    </dd>
                                </dl>
                                <dl class="sp_newpai">
                                    <dt></dt>
                                    <dd>
                                        <input value="保存" class="member_info_subbtn" id="info_submit" type="submit">
                                        <input class="member_info_canclebtn" name="" value="取消" onclick="cancelOpertion()" type="button">
