...
<div id="member_left" class="flt">
    <div class="member_leftMenu">
        ...
        <ul>
            ...
            <li><a class="curr" id="FavoriteProduct" href="/hszz/TP/index.php/Profiles">其他收货地址</a></li>
		</ul>		
...
<form action="/hszz/TP/index.php/profiles/update" id="accountfrom" method="post" name="accountfrom">  
                        ...
                        <div id="member_user_content">
                            ...
                            <div id="spAccount-myinfo_form" class="clr">
								...
								<dl>
                                    ...
                                    <dd>
                                        <span>
                                            <input name="profile_region"  value="<?php echo ($profile['profile_region']); ?>" id="info_mobile" >
                                        </span>
                                    </dd>
                                </dl>
								...
								<dl>
                                    ...
                                    <dd>
                                        <span>
                                            <input name="profile_street"  value="<?php echo ($profile['profile_street']); ?>" id="info_mobile"  type="text">
                                        </span>
                                    </dd>
                                </dl>
								...
								<dl>
                                    ...
                                    <dd>
                                        <span>
                                            <input name="profile_address" value="<?php echo ($profile['profile_address']); ?>"  id="info_mobile"  type="text">
                                        </span>
                                    </dd>>
                                </dl>
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        <span>
                                            <input name="profile_name" value="<?php echo ($profile['profile_name']); ?>"  id="info_mobile"  type="text">
                                        </span>
                                    </dd>
                                </dl>
                                <dl id="mobilearea">
                                    ...
                                    <dd>
                                        <span>
                                            <input name="profile_phone" value="<?php echo ($profile['profile_phone']); ?>"  id="info_mobile"  type="text">
                                        </span>
                                        <div>
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        <span>
                                            <input name="profile_code" value="<?php echo ($profile['profile_code']); ?>" id="info_code" type="text">
                                        </span>
                                    </dd>
                                </dl>
                                <dl class="sp_newpai">
