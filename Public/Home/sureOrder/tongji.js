...
function lz_main()
{
	...
	var server_time = "1372043232";
	var verify_code = "a9923ffd";
	var type        = "0";
	var dest_path   = "http://click.$$$.com/tongji.php?unit_id="+unit_id; 
   ...
   if(domain.indexOf('aolai.com')>-1) {
	dest_path= dest_path.replace("$$$","aolai");
   }else{
	dest_path= dest_path.replace("$$$","shangpin");
   }
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0){
				...
				var dd=date.getDate(); 
				var fd =yy+mm+dd;
                document.write('<scr'+'ipt src=\'http://js11.shangpin.com/clickcollect.js?v='+fd+'\'></scr'+'ipt>');
				}
}
